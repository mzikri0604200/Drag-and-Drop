...
},{"blueimp-tmpl":1}],5:[function(require,module,exports){
(function (global){
'use strict';
...
_qunit2.default.module('videojs-related', {
...
_qunit2.default.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(Player.prototype.related, _plugin2.default, 'videojs-related plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-related'), 'the plugin adds a class to the player');
});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../src/plugin":4,"global/document":3}]},{},[5]);
